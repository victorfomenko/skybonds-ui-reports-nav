...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Groups = __webpack_require__(18);
	...
	var _Mini = __webpack_require__(20);
	...
	var UIReportsNav = function (_Component) {
	  _inherits(UIReportsNav, _Component);

	  function UIReportsNav(props) {
	    _classCallCheck(this, UIReportsNav);

	    var _this = _possibleConstructorReturn(this, (UIReportsNav.__proto__ || Object.getPrototypeOf(UIReportsNav)).call(this, props));

	    _this.onReportsClick = _this.onReportsClick.bind(_this);
	    _this.addListener();
	    return _this;
	  }

	  _createClass(UIReportsNav, [{
	    key: 'onReportsClick',
	    value: function onReportsClick(e) {
	    ...
	    value: function addListener() {
	      window.onclick = function () {
	        var element = document.querySelector('.' + _reports2.default.reports);
	        if (element.className) {
	          var newClassName = element.className.replace('' + _reports2.default.reports_open, '');
	    ...
	    key: 'expandReportNav',
	    value: function expandReportNav(e) {
	      e.stopPropagation();
	      var target = e.target;
	      var currentTarget = e.currentTarget;
	      if (this.hasClass(target, _reports2.default.icon) || this.hasClass(currentTarget, _reports2.default.reports_open)) {
	        return;
	      }

	      currentTarget.className = currentTarget.className + ' ' + _reports2.default.reports_open;
	    }
	  }, {
	    key: 'hasClass',
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: _reports2.default.reports, onClick: this.onReportsClick },
	...
	UIReportsNav.propTypes = {
	  ...
	  onRemoveReport: _react2.default.PropTypes.func.isRequired,
	  onRenameReport: _react2.default.PropTypes.func.isRequired,
	  onSelectReport: _react2.default.PropTypes.func.isRequired
	};

		exports.default = UIReportsNav;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ListItem = function (_Component) {
	  ...
	  function ListItem(props) {
	    ...
	    _this.state = _this.formatState(props);
	    _this.onClickRemoveBtn = _this.onClickRemoveBtn.bind(_this);
	    _this.onClickEditBtn = _this.onClickEditBtn.bind(_this);
	  ...
	  _createClass(ListItem, [{
	    ...
	    key: 'formatState',
	    value: function formatState(props) {
	      return {
	        id: props.id,
	        name: props.name,
	        disabled: props.disabled,
	    ...
	    key: 'onClickEditBtn',
	    value: function onClickEditBtn(e) {
	    ...
	    key: 'onClickRemoveBtn',
	    value: function onClickRemoveBtn() {
	    ...
	    value: function render() {
	      ...
	      var activeClass = this.state.active ? ' ' + _reports2.default.active : '';

	      return _react2.default.createElement(
	        'li',
	        { className: '' + _reports2.default.item + activeClass, onClick: function onClick(e) {
	            _this2.props.onClick(e, _this2.state.id);
	          } },
	        _react2.default.createElement(
	          'svg',
	          { className: _reports2.default.icon + ' ' + _reports2.default.icon_market },
	          _react2.default.createElement('use', { xlinkHref: '/static/icons/sprite.svg#explorer-market' })
	        ),
	        ...
	        _react2.default.createElement(
	          'span',
	          { className: _reports2.default.icon + ' ' + _reports2.default.icon_edit,
	            onClick: this.onClickEditBtn },
	          'edit'
	        ),
	        _react2.default.createElement(
	          'svg',
	          { className: _reports2.default.icon + ' ' + _reports2.default.icon_trash,
	            onClick: this.onClickRemoveBtn },
	          _react2.default.createElement('use', { xlinkHref: '/static/icons/sprite.svg#explorer-trash' })
	        )
	      );
	    }
	  }]);
	...
	ListItem.propTypes = {
	  ...
	  onRenameReport: _react2.default.PropTypes.func.isRequired,
	  onClickRemoveBtn: _react2.default.PropTypes.func.isRequired
	};
	...
	var Groups = function (_Component) {
	  ...
	  _createClass(Groups, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: _groups2.default.groups },
	        '\'122135s5\''
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var List = function (_Component) {
	  ...
	  function List(props) {
	    ...
	    var reports = _this.formatReportsState(props);
	    _this.state = { reports: reports };
	    _this.onClickRemoveBtn = _this.onClickRemoveBtn.bind(_this);
	    _this.onClickLiItem = _this.onClickLiItem.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(List, [{
	    key: 'componentWillReceiveProps',
	    value: function componentWillReceiveProps(props) {
	      var reports = this.formatReportsState(props);
	      this.setState({ reports: reports });
	    }
	  }, {
	    key: 'formatReportsState',
	    value: function formatReportsState(props) {
	      return props.reports.map(function (item) {
	        item.disabled = true;
	    ...
	    key: 'onClickRemoveBtn',
	    value: function onClickRemoveBtn(id) {
	      var newReports = this.state.reports.filter(function (item) {
	        return id !== item.id;
	      });
	    ...
	    key: 'onClickLiItem',
	    value: function onClickLiItem(e, id) {
	      ...
	      if (hasClass(element, _reports2.default.icon)) {
	        return;
	      }

	      var newReports = this.state.reports.map(function (item) {
	    ...
	    value: function render() {
	      ...
	      var reportsList = reports.map(function (item, index) {
	        return _react2.default.createElement(_ListItem2.default, {
	          onClick: _this2.onClickLiItem,
	          key: index,
	          active: item.active,
	          disabled: item.disabled,
	          name: item.name,
	          id: item.id,
	          onRenameReport: _this2.props.onRenameReport,
	          onClickRemoveBtn: _this2.onClickRemoveBtn,
	          onChange: function onChange(value) {
	            var newReports = reports.map(function (item) {
	              if (value.id === item.id) {
	                item.name = value.name;
	              }
	              return item;
	            });
	            _this2.setState({ reports: newReports });
	          }
	        });
	      });
	      return _react2.default.createElement(
	        'div',
	        { className: _reports2.default.listBox },
	        _react2.default.createElement(
	          'ul',
	          { className: _reports2.default.ul },
	          reportsList
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Mini = function (_Component) {
	  _inherits(Mini, _Component);

	  function Mini(props) {
	    _classCallCheck(this, Mini);

	    var _this = _possibleConstructorReturn(this, (Mini.__proto__ || Object.getPrototypeOf(Mini)).call(this, props));
	  ...
	  _createClass(Mini, [{
	    key: 'componentWillReceiveProps',
	    value: function componentWillReceiveProps(props) {
	      var state = this.formatReportsState(props);
	      this.setState(state);
	    }
	  }, {
	    key: 'formatState',
	    value: function formatState(props) {
	      ...
	      props.reports.forEach(function (item) {
	        if (item.active) {
	          id = item.id;
	          name = item.name;
	      ...
	      return { id: id, name: name, disabled: disabled, active: active };
	    }
	  }, {
	    key: 'render',
	    value: function render() {
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"groups":"groups__groups___3ypGX"};
